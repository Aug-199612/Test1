...
public class vector {
	...
	public static void main(String[] args) {
		...
		Vector al1=new Vector();    //by default it has 10 capacity
		Vector al2=new Vector(1500);   //Customize default capacity=1500
		Vector al3 = new Vector();   //create equivalent collection from existing
